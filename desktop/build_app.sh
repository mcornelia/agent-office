...
cp "$repo_root/server.py" "$repo_root/activity_state.py" "$repo_root/desktop_status.py" "$repo_root/communications.py" "$repo_root/job_board.py" "$repo_root/manager_gate.py" "$repo_root/desktop_dispatch.py" "$repo_root/index.html" "$runtime/"
